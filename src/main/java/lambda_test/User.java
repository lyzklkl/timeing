...
public class User {
    ...
    public static List<User> getUserList() {
        ...
        userList.add(User.builder().userId("5260c4cf-04dd-411a-8785-4894406cf5d3").name("郑阳伯").age(29).gender(0).build());
        ...
        userList.add(User.builder().userId("d33c9ea4-cd6f-4596-a6c6-0e5c0b9a68ed").name("袁寄灵").age(35).gender(1).build());
